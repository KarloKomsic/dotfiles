...
## Install guide
This repo will assume you already have the necessary software installed, as to reduce the size of this guide.
...
cd Dotfiles/
```
To install the dotfiles, head to the scripts/ directory:
```bash
cd scripts/
```
